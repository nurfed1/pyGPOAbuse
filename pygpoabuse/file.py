...
class File:
    def __init__(self, source_path, destination_path, mod_date="", old_value=""):
        if mod_date:
        ...
        self._file_str = f"""<File clsid="{{50BE44C8-567A-4ed1-B1D0-9234FE1F38AF}}" name="{destination_filename}" status="{destination_filename}" image="0" changed="{self._mod_date}" uid="{{{self._guid}}}" bypassErrors="1"><Properties action="C" fromPath="{source_path}" targetPath="{destination_path}" readOnly="0" archive="1" hidden="0"/></File>"""
